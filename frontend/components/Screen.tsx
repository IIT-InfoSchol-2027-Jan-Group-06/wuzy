...
/** Shell for every route: bg, safe area, the top token under the inset, 32 sides (padded), full width on every screen. scroll = ScrollView that clears the NavBar on tab screens. overlay = floating controls above the content. */
