    ...
    <Pressable
      ...
      <View className="flex-1 flex-row items-center" style={{ padding: 16, gap: wuzyLayout.itemGap }}>
        <View className="flex-1 justify-end" style={{ gap: 6 }}>
          <Text
            numberOfLines={2}
            style={{ fontFamily: wuzyFonts.bold, fontSize: fontSize('body'), lineHeight: Math.round(fontSize('body') * 1.3), color: wuzyColors.white }}>
            {event.title}
          </Text>
          <View className="flex-row items-center" style={{ gap: 8 }}>
            <Image
              ...
              contentFit="cover"
            />
            <Text numberOfLines={1} style={{ fontFamily: wuzyFonts.semibold, fontSize: fontSize('small'), color: wuzyColors.white }}>
              {event.hostName}
            </Text>
          </View>
        </View>
        ...
        <View
          ...
          <Text
            className="uppercase"
            style={{ fontFamily: wuzyFonts.semibold, fontSize: fontSize('caption'), color: wuzyColors.bg, letterSpacing: 1 }}>
            {event.dateMonth}
          </Text>
        </View>
      </View>
